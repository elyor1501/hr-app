        ...
        <SidebarInset className="flex flex-col overflow-hidden relative">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div 
              ...
              style={{ background: 'radial-gradient(circle, #429ABD 0%, #F5A623 100%)' }}
            />
          </div>
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <main className="flex-1 overflow-y-auto bg-background/50 custom-scrollbar">
              <div className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-200">
                {children}
              </div>
            </main>
          </div>
