...
function getCurrencySymbol(currency: string): string {
  const symbols: Record<string, string> = {
    EUR: "€", USD: "$", GBP: "£", INR: "₹", AED: "AED", SGD: "SGD",
    AUD: "A$", CAD: "C$", CHF: "CHF", JPY: "¥", CNY: "¥", SAR: "SAR", MYR: "MYR",
  };
...
export default function CandidateDetails({ id, empData }: Props) {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      ...
      if (updatedCandidate?.proposed_rate_type) setProposedRateType(updatedCandidate.proposed_rate_type);
      if (updatedCandidate?.proposed_currency) setProposedCurrency(updatedCandidate.proposed_currency);
      setIsEditing(false);
  ...
  return (
    <div className="max-w-6xl mx-auto bg-card text-card-foreground rounded-xl shadow-sm border border-border p-4 sm:p-6 md:p-8">
      ...
      <Tabs defaultValue="basic" className="w-full">
        ...
        <form key={isEditing ? "edit" : "view"} id="candidate-form" action={handleSubmit} className="mt-4 sm:mt-6">
          ...
          <TabsContent value="basic" className="space-y-4 sm:space-y-6">
            <div className="flex justify-end">
              {!isEditing ? (
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  ...
                  <button form="candidate-form" type="submit" disabled={loading}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div>
                ...
                <input name="full_name" defaultValue={`${candidate.first_name} ${candidate.last_name}`} disabled className={fieldClass} />
              </div>
              <div>
            ...
            <div>
              ...
              <textarea name="skills" defaultValue={(candidate.skills || []).join(", ")} disabled rows={6} className={fieldClass} />
            </div>
