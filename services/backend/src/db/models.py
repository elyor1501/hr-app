...
class Candidate(BaseModel):
    ...
    proposed_daily_rate: Mapped[Optional[float]] = mapped_column(Numeric(10, 2), nullable=True)
    proposed_currency: Mapped[Optional[str]] = mapped_column(String(10), nullable=True, default="EUR")
    ...
    willing_to_travel: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True, default=False)
    willing_inperson: Mapped[Optional[bool]] = mapped_column(Boolean, nullable=True, default=False)
