...
from src.api.v1.deloitte_resume import router as deloitte_resume_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(deloitte_resume_router, prefix="/api/v1/candidates", tags=["deloitte-resume"])
